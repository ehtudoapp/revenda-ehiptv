...
<style scoped>
.sidebar { width:13.75rem; background:#0f1724; color:white; padding:1rem }
.sidebar .brand { font-weight:700; margin-bottom:1rem }
.sidebar nav a { display:block; padding:0.5rem 0.25rem; color:inherit; text-decoration:none; border-radius:0.25rem }
...
@media (max-width: 768px) {
  ...
  .sidebar { position: fixed; top: 0; right: 0; height: 100vh; width: 16.25rem; transform: translateX(100%); transition: transform .25s ease; padding:0; z-index: 1001 }
